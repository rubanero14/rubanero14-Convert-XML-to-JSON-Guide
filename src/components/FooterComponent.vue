<template>
    ...
    <footer class="full-length">
        ...
        <strong>
            <a target="_blank" class="text-secondary ms-1" style="text-decoration: none;" href="https://github.com/rubanero14/Multi-RSS-News-Feed-Vue3">RUBANERO</a>
        </strong>
    </footer>
</template>
<script>
export default {
    ...
    methods: {
        showLowerBackBtn() {
            ...
            if (this.tabNav === 2) {
                return  this.topicData !== undefined && this.feeds.length > 4;
            }
        },
    }
}
