<template>
    <div>
        ...
        <h1 class="text-secondary mb-1">
          <strong>RSSFeeder<sup>++</sup></strong>
        </h1>
        ...
        <div class="alert alert-dark" role="alert">
          Add new feed? Submit a <a target="_blank" class="issue btn-sm btn-secondary" href="https://github.com/rubanero14/Multi-RSS-News-Feed-Vue3/issues">ticket</a>
        </div>
