<template>
    <div>
        ...
        <h1 class="text-secondary mb-1">
          <strong>newsFeeds<sup>++</sup></strong>
        </h1>
        <label class="text-secondary mb-4">
          <strong>
            Powered by           
        ...
        <div class="alert alert-dark" role="alert">
          Add new feed? Submit a <a target="_blank" class="issue btn-sm btn-secondary" href="https://github.com/rubanero14/RSS-Feed-CP-Prototype-Vue3/issues">ticket</a>
        </div>
...
<script>
export default {
  props: ['tabNav', 'isloading', 'isError', 'showSourceCode', 'devActivationCount'],
}
</script>
<style scoped>
.issue {
